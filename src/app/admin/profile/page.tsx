...
export default function AdminProfilePage() {
  ...
  if (loading) {
    return (
      <div
        className="rounded-2xl p-6 md:p-8 space-y-6 animate-pulse"
        style={{ backgroundColor: 'var(--color-surfaceContainerLowest)', boxShadow: '0 4px 24px rgba(13, 16, 33, 0.08)' }}
      >
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl space-y-6">
        <ProfileHeader fullName={fullName} role="Admin" location="Lagos" />
        ...
        >
          {editing ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-medium text-token-onSurfaceVariant">User Role</label>
                <input
                  type="text"
                  className="input-field opacity-60 cursor-not-allowed"
                  value="Admin"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <FieldRow label="User Role" value="Admin" readOnly />
